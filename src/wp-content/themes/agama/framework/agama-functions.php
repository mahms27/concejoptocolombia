...
function add_static_resource() {   
    ...
    $concejales  = 'concejales-actuales';
    
 	wp_register_script('utility', get_template_directory_uri(). '/assets/js/utility.js', array('jquery'), '1', true );
	wp_enqueue_script('utility');

	wp_register_style( 'utility-form', get_stylesheet_directory_uri() . '/assets/css/utility-form.css' );
	wp_enqueue_style('utility-form', get_bloginfo('stylesheet_url'), true, true, 'screen');   

    if ( is_page( $contacto  )  ) {
    	wp_register_style( 'contact-form', get_stylesheet_directory_uri() . '/assets/css/contact-form.css' );
    	wp_enqueue_style('contact-form', get_bloginfo('stylesheet_url'), true, true, 'screen');
             
        wp_register_script('contact-form-js', get_template_directory_uri(). '/assets/js/contact-form.js', array('jquery'), '1', true );
    	wp_enqueue_script('contact-form-js');     
    }  
     if ( is_page( $concejales  )  ) {
     	wp_register_style( 'rotatingcard', get_stylesheet_directory_uri() . '/assets/css/rotatingcard.css' );
    	wp_enqueue_style('rotatingcard', get_bloginfo('stylesheet_url'), true, true, 'screen');
...
add_action( 'wp_enqueue_scripts', 'add_static_resource' ); 
